...
impl ClosureFlag {
    ...
    pub fn is_mutable(&self) -> bool {
        (self.0) & (Self::_MUT.0) != 0
    }

    #[inline(always)]
    pub fn is_bitmap(&self) -> bool {
        (self.0) & (Self::_BTM.0) != 0
    }

    #[inline(always)]
    pub fn is_thunk(&self) -> bool {
        (self.0) & (Self::_THU.0) != 0
    }

    #[inline(always)]
    pub fn is_unpointed(&self) -> bool {
        (self.0) & (Self::_UPT.0) != 0
    }

    #[inline(always)]
    pub fn has_srt(&self) -> bool {
        (self.0) & (Self::_SRT.0) != 0
    }
...
impl std::fmt::Debug for Bitmap {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> std::fmt::Result {
        unsafe { write!(f, "Bitmap({:?})", self.small_bitmap) }
    }
}
...
pub struct StgLargeBitmapRef {
    pub offset: StgInt, // TODO: handle non TABLES_NEXT_TO_CODE
}
